<?php
	...
	{
		$data['grup'] = $this->Mahasiswa_model->getGrup()->result(); //mengambil data array dari database melalui model
		$this->template->views('crud/home_grup',$data); //menampilkan file view home_mahasiswa dengan menggunakan library template
